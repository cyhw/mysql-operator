...
import (
	...
	mysql "github.com/cyhw/mysql-operator/pkg/clients/informers/externalversions/mysql"
...
type SharedInformerFactory interface {
	...
	Volc() mysql.Interface
}

func (f *sharedInformerFactory) Volc() mysql.Interface {
